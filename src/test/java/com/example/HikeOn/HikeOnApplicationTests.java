...
class CustomerServiceTest {
	...
	void saveCustomer_ValidCustomer_Success() {
		// Arrange
		Customer customer = new Customer("John Doe", "john.doe@example.com", LocalDate.of(1990, 1, 1),
	...
	void saveCustomer_Under18_ExceptionThrown() {
		// Arrange
		Customer customer = new Customer("John Doe", "john.doe@example.com", LocalDate.now().minusYears(17),
				Occupation.DEVELOPER);
